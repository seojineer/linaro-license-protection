...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'APIToken.ip'
        db.add_column('license_protected_downloads_apitoken', 'ip', self.gf('django.db.models.fields.CharField')(max_length=40, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'APIToken.ip'
        db.delete_column('license_protected_downloads_apitoken', 'ip')
